...
public class scheduleBuilderControl { 
    ...
    @FXML private ComboBox<String> selectADay;
    ...
    private void loadDaysOfWeek() {
    	ObservableList<String> daysWorkable = FXCollections.observableArrayList();
    	daysWorkable.add("Monday");
    	daysWorkable.add("Tuesday");
    	daysWorkable.add("Wednesday");
    	daysWorkable.add("Thursday");
    	daysWorkable.add("Friday");
    	selectADay.setItems(daysWorkable);
    }
    @FXML
